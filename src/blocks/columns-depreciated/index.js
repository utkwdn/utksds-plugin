...
registerBlockType( 'utksds/columns', {
	...
	transforms: {
		to: [
			{
				type: 'block',
				blocks: [ 'utkwds/columns' ],
				transform: ( attributes, innerBlocks ) => {
					return createBlock( 'utkwds/columns',
						attributes,
						Array.isArray(innerBlocks)
							? innerBlocks.map(block => {
								if (block.name === 'utksds/column') {
									return createBlock('utkwds/column', block.attributes, block.innerBlocks);
								} else {
									return block;
								}
							})
  ...
  <path fillRule="nonzero" d="M39 12a2 2 0 011.995 1.85L41 14v20a2 2 0 01-1.85 1.995L39 36H9a2 2 0 01-1.995-1.85L7 34V14a2 2 0 011.85-1.995L9 12h30zm-24 2H9v20h6V14zm8 0h-6v20h6V14zm2 0v20h6V14h-6zm8 20h6V14h-6v20z" />
</svg>
		),
