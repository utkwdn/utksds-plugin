	...
	edit: () => {
		return (
			...
			<div className='home-jumbotron-caption-inside'>
				<InnerBlocks allowedBlocks={ [ 'core/button', 'core/paragraph', 'core/heading', 'core/list', 'core/quote', 'lead/main', 'horizontal-rule/main', ] } renderAppender={ () => ( <InnerBlocks.DefaultBlockAppender /> ) } />
			</div>
			</div>
		);
	},
